    ...
    <div className="min-h-screen bg-base-100 text-base-content flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center">
        <div className="text-center px-4 relative z-0">
            <div className="absolute -inset-20 bg-gradient-to-r from-blue-600 to-blue-700 opacity-10 blur-3xl rounded-full" aria-hidden="true"></div>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-700">
            ...
            <div className="mt-8">
                ...
                className="px-8 py-3 text-lg font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-full hover:scale-105 transform transition-transform duration-300 ease-in-out shadow-lg"
                >
                Get Started Now
                </button>
            </div>
