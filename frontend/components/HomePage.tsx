      ...
      <header className="absolute top-0 left-0 right-0 p-4 sm:p-6 lg:p-8 z-10">
        <nav className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center gap-2 text-base-content">
            ...
            <h1 className="font-semibold text-lg hidden sm:block">Room Furniture Extractor</h1>
          </div>
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={onRegister}
              className="px-4 py-2 text-sm font-medium text-white bg-brand-primary rounded-lg hover:bg-opacity-80 transition-colors">
              Register
            </button>
          </div>
        </nav>
      ...
      <main className="flex-grow flex items-center justify-center">
        <div className="text-center px-4 relative z-0">
            ...
            <div className="mt-8">
                ...
                className="px-8 py-3 text-lg font-semibold text-white bg-gradient-to-r from-brand-primary to-brand-secondary rounded-full hover:scale-105 transform transition-transform duration-300 ease-in-out shadow-lg"
                >
                Get Started Now
                </button>
            </div>
